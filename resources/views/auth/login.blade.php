...
<section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 to-purple-100 py-20 px-4">
    <div class="bg-white shadow-2xl rounded-xl p-10 w-full max-w-md">
        <h2 class="text-3xl font-bold text-center text-indigo-600 mb-8">ورود به حساب کاربری</h2>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            حساب ندارید؟ <a href="{{ route('register') }}" class="text-indigo-600 hover:underline font-semibold">ثبت‌نام</a>
        </p>
        <p class="text-center text-sm text-gray-500 mt-6">
            رمزعبور را فراموش کردی؟ <a href="{{ route('forgetPassword') }}" class="text-indigo-600 hover:underline font-semibold">بازیابی</a>
        </p>
    </div>
</section>
<script>
